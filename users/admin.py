...
class UserAdmin(admin.ModelAdmin):
    list_display = ['image_tag', 'user_name', 'user_fname', 'user_lname', 'user_email', 'user_branch', 'user_position']
    # ordering = ()
    ...
    fieldsets = (
                ...
                ('Permissions', {'fields': ('is_staff', 'is_active', 'is_superuser','can_selectbranch')}),
